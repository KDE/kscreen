...
{
    return {
        {SwitchToExternal, i18nd("kscreen_common", "Only use secondary screen"), QStringLiteral("osd-shutd-laptop")},
        {SwitchToInternal, i18nd("kscreen_common", "Only use primary screen"), QStringLiteral("osd-shutd-screen")},
        {Clone, i18nd("kscreen_common", "Mirror screens"), QStringLiteral("osd-duplicate")},
        {ExtendLeft, i18nd("kscreen_common", "Extend to left of primary screen"), QStringLiteral("osd-sbs-left")},
        {ExtendRight, i18nd("kscreen_common", "Extend to right of primary screen"), QStringLiteral("osd-sbs-sright")},
