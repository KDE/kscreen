...
Kirigami.FormLayout {
    ...
    RowLayout {
        ...
        visible: (!root.hdrAvailable || !element.hdr) && (element.capabilities & KScreen.Output.Capability.ExtendedDynamicRange)
        ...
        Kirigami.ContextualHelpButton {
            toolTipText: xi18nc("@info:tooltip", "EDR dynamically adjusts display brightness for better HDR playback.<nl/><nl/>
                                                  Note that this increases battery usage while viewing HDR content.")
        }
    }
